...
def main():
    ...
    if args.load_generations_path:
        ...
        for task in task_names:
            results[task],test_case_results = evaluator.evaluate(task)
            ...
            if args.generation_only:
                ...
                if accelerator.is_main_process:
                    ...
                    # 如果路径不存在，创建文件夹
                        ...
                        save_dir  = args.save_generations_path+'/generations.json'
                    with open(save_dir, "w") as fp:
                        json.dump(generations, fp)
                        print(f"generations were saved at {save_dir}")
                    # if args.save_references:
                    #     save_dir = args.save_generations_path+'/references.json'
